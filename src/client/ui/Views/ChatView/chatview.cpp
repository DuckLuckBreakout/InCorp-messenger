...
ChatView::ChatView(QWidget *parent) : QListView(parent) {
    ...
    "QListWidget::item:hover{   background-color:  rgb(0, 0, 243);selection-color: transperent;}"
    "QListWidget::item:selected{ background-color:  rgb(0, 0, 0);selection-color: transperent;}"
    );
...
void ChatView::scrollWhileDataChanged() {
    this->scrollToBottom();
}
